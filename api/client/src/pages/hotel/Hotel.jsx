...
const Hotel = () => {
  ...
  // const startDay = JSON.stringify(localStorage.getItem("startDate"));

  // const endDay = JSON.stringify(localStorage.getItem("endDate"));

  // function dayDifference(startDay, endDay) {
  ...
  // const days = dayDifference(startDay, endDay);
            ...
            <div className="hotelWrapper">
              ...
              <div className="hotelDetails">
                ...
                <div className="hotelDetailsPrice">
                  <h1>Perfect hotel {data.name} for stay!</h1>
                  <span className="stayIn">
                    Located in the real heart of <b>{data.city}</b>, this
